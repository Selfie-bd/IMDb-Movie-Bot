...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("🎬 Movie", url="https://t.me/HdFlimz"),
                InlineKeyboardButton("Series 🎥", url="https://t.me/umlinks")
            ])
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                ...
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/groupdcbots')
            ],
            [
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/flimrequest'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/umlinks')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/HdFlimz')
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/groupdcbots'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/umlinks')
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Adult Bot 🔞', url='https://t.me/movie18only')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/Groupdcbots/7221'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie", url="https://t.me/umlinks"),
        InlineKeyboardButton("Series ⭕️", url="https://t.me/HdFlimz")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/Groupdcbots/7774")
    ])
